...
| `"parents"`     | Number    | Count of parents |
| `"children"`    | Number    | Count of children |
| `"generation"`  | Number    | Count of generations that came before this individual |
| `"ascension"`   | Number    | Count of individuals who died before this one |
...
Newlines are permissible.
Leading and trailing whitespace should be discarded.
2) A single NULL character: represented by the hex code: `\x00`
